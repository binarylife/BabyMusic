...
public class NetworkUtils {
	 ...
	 *         {@code false}: 否
	 */
	@RequiresApi(api = Build.VERSION_CODES.CUPCAKE) public static boolean is4G(Context context) {
...
//				wifiManager.setWifiEnabled(false);
	 ...
	 *         </ul>
	 */
	@RequiresApi(api = Build.VERSION_CODES.CUPCAKE) public static int getNetworkType(Context context) {
	 ...
	 *         </ul>
	 */
	@RequiresApi(api = Build.VERSION_CODES.CUPCAKE) public static String getNetworkTypeName(Context context) {
	 ...
	 * @return IP地址
	 */
	@RequiresApi(api = Build.VERSION_CODES.GINGERBREAD) public static String getIPAddress(boolean useIPv4) {
		try {
